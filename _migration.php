...
$request4 = "CREATE TABLE `checks` (
	...
	`summ_m+a` VARCHAR(50) DEFAULT NULL,
	...
	`summ_tax_m+a` VARCHAR(50) DEFAULT NULL,
	PRIMARY KEY (`id`)
);";
...
$request6 = "CREATE TABLE `balances` (
	...
	`sale_summ_m+a` VARCHAR(50) DEFAULT NULL,
	...
	`sale_summ_tax_m+a` VARCHAR(50) DEFAULT NULL,
	...
	`return_summ_m+a` VARCHAR(50) DEFAULT NULL,
	...
	`return_summ_tax_m+a` VARCHAR(50) DEFAULT NULL,
