...
<body>
	...
	<section class="main">
		...
		<div class="mainItem">
			...
			<p class="mainItemP">
				ОБІГ М: .................... <?php echo $_SESSION['balance']['sale_summ_m']; ?> грн
			</p>
			<br>
			<p class="mainItemP">
			...
			<p class="mainItemP">
				ЗБІР М 05%: ............ <?php echo $_SESSION['balance']['sale_summ_tax_m']; ?> грн
			</p>
			<p class="mainItemP">
		...
		<div class="mainItem c<?php echo $_SESSION['balance']['return_checks']; ?>">
			...
			<p class="mainItemP">
				ОБІГ М: .................... <?php echo $_SESSION['balance']['return_summ_m']; ?> грн
			</p>
			<br>
			<p class="mainItemP">
			...
			<p class="mainItemP">
				ЗБІР М 05%: ............ <?php echo $_SESSION['balance']['return_summ_tax_m']; ?> грн
			</p>
			<p class="mainItemP">
