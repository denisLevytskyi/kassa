	...
	<section class="editAuth">
		<div class="container">
			<form action="/editAuth.php" class="editAuthForm" method="POST" enctype="application/x-www-form-urlencoded">
				...
				<input type="text" class="editAuthFormInp" name="edit_auth_name" value="<?php echo $_SESSION['auth']['name'];?>" required>
				<input type="text" class="signFormInp" name="edit_auth_login" value="<?php echo $_SESSION['auth']['login'];?>" required>
